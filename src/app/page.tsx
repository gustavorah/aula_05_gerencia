...
export default function TarefaView() {
  ...
  const createTarefa = async (tarefa: NovaTarefa) => {
    try {
      ...
      showFeedback(`Erro ao criar tarefa: ${error instanceof Error ? error.message : "Erro desconhecido"}`, true);
    }
  };
  ...
  const updateTarefa = async (id: number, tarefa: NovaTarefa) => {
    try {
      ...
      showFeedback(`Erro ao atualizar tarefa: ${error instanceof Error ? error.message : "Erro desconhecido"}`, true);
    }
  };
  ...
  const deleteTarefa = async (id: number) => {
    ...
    try {
      ...
      showFeedback(`Erro ao excluir tarefa: ${error instanceof Error ? error.message : "Erro desconhecido"}`, true);
    }
  };
  ...
  const startEditing = (tarefa: Tarefa) => {
    setCurrentTask({
      ...
      data_encerramento: tarefa.data_encerramento ? formatDateForInput(tarefa.data_encerramento) : null,
  ...
  const handleExport = async () => {
    try {
      ...
      const queryString = queryParams.toString();
      const url = queryString ? `/api/tarefas/export?${queryString}` : "/api/tarefas/export";
      ...
      showFeedback(`Erro ao exportar para PDF: ${error instanceof Error ? error.message : "Erro desconhecido"}`, true);
    } finally {
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      {/* Feedback message */}
      {feedback && (
        <div className={`p-4 mb-4 rounded ${feedback.isError ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
          {feedback.message}
        </div>
      )}
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block text-gray-700 font-bold mb-2" htmlFor="data_previsao">
                  Data de Previsão:
                </label>
                <input
                  type="datetime-local"
              ...
              <div>
                <label className="block text-gray-700 font-bold mb-2" htmlFor="data_encerramento">
      ...
      <div className="bg-gray-100 p-4 rounded-lg shadow-md mb-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end space-y-2 md:space-y-0 md:space-x-4 mb-4">
          <div className="w-full">
            <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="dateFrom">
              Data Inicial
            </label>
            <input
              type="date"
          ...
          <div className="w-full">
            <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="dateTo">
              Data Final
            </label>
            <input
              type="date"
      ...
      {showExportModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
            <h3 className="text-xl font-bold mb-4">Exportar Lista de Tarefas</h3>
            
            <div className="mb-4">
              <p className="mb-2 text-gray-700">Configure as opções de exportação:</p>
              
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="exportStatus">
                  Status das Tarefas
                </label>
                <select
                  id="exportStatus"
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="exportDateFrom">
                    Data Inicial
                  </label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="exportDateTo">
                    Data Final
                  </label>
                  <input
                    type="date"
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="exportSearch">
      ...
      <div className="space-y-4">
        ...
        {tarefas.length === 0 ? (
          ...
          tarefas.map((tarefa) => (
            <div key={tarefa.id} className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    <span className="font-bold text-gray-700">Encerramento:</span>{" "}
                    {tarefa.data_encerramento ? formatDate(tarefa.data_encerramento) : "Não encerrada"}
                  </p>
                </div>
